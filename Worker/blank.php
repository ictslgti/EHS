                    ...
                    <div class="col-lg-12 p-r-0 title-margin-right">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <img src ="workers.png" alt="Italian Trulli"> </center>
                            </div>
                            <div class="card-body">
                                <!-- your content start  -->
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="column">
                                            ...
                                            ?>
                                                    ...
                                                    var motivationLevels =
                                                    <?php echo json_encode($motivationLevels); ?>;
                                                    ...
                                                    <body>
                                                        ...
                                                        var data = {
                                                            ...
                                                            datasets: [{
                                                                ...
                                                                data: [<?php echo $totalJobs; ?>,
                                                                    <?php echo $completedJobs; ?>,
...
<head>
    <title>Demographics Chart</title>
    <style>
    table {
...
<body>
    ...
    <table>
        ...
        <tr>
            <td>Male <img src=male-icon-15.png alt=male-icon-15 class="percentage-image"></td>
            <td>42.35%</td>
        </tr>
        <tr>
            <td>Female <img src="female.png" alt="Female Sticker" class="percentage-image"></td>
            <td>60.55%</td>
        </tr>
        <tr>
